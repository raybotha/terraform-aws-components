...
| <a name="module_github_oidc_provider"></a> [github\_oidc\_provider](#module\_github\_oidc\_provider) | cloudposse/stack-config/yaml//modules/remote-state | 1.0.0 |
...
| <a name="input_global_tenant_name"></a> [global\_tenant\_name](#input\_global\_tenant\_name) | The tenant name used for organization-wide resources | `string` | `"mgmt"` | no |
